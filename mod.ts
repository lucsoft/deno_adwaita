                ...
                new PreferencesGroup()
                    ...
                    .add(
                        new ActionRow()
                            ...
                            .setProperty(
                                "subtitle",
                                "This is a subtitle for the action row.",
                            )
                    ...
                    .add(
                        new SwitchRow()
                            ...
                            .onActive((self) => {
                                console.log(
                                    `Switch is now ${self.active ? "ON" : "OFF"}`,
                                );
                            }),
                    )
                    .add(
                    ...
                    .add(
                        new SpinRow({ min: 0, max: 100, step: 1 })
                            ...
                            .setProperty(
                                "subtitle",
                                "Adjust the value using the spinner.",
                            )
                            .onValue((self) => {
