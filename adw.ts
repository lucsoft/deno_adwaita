...
export class Application extends GtkApplication {
    ...
    constructor(
        ...
        super(
            adwaita.symbols.adw_application_new(cString(applicationId), flags),
        );
    }
...
export class ApplicationWindow extends GtkApplicationWindow {
    ...
    static override create(application: GtkApplication) {
        return new ApplicationWindow(
            adwaita.symbols.adw_application_window_new(
...
export class PreferencesPage extends GtkWidget {
    ...
    scrollToTop() {
        adwaita.symbols.adw_preferences_page_scroll_to_top(
            this.internalPointer,
        );
        return this;
    }
...
export class SwitchRow extends ActionRow {
    ...
    onActive(callback: (self: this) => void) {
        this.connect(
            "notify::active",
            new DefaultHandler(() => callback(this)),
        );
        return this;
    }
}
...
export class PreferencesDialog extends Dialog {
    ...
    popSubpage() {
        adwaita.symbols.adw_preferences_dialog_pop_subpage(
            this.internalPointer,
        );
        return this;
    }
...
export class AlertDialog extends Dialog {
    ...
    addResponse(response: Response) {
        if (this.#responses.has(response.id)) {
            throw new Error(
                `Response with id "${response.id}" already exists.`,
            );
        }
        ...
        this.connect(
            ...
            new GCallback(
                ...
                (_, responseId) => {
                    ...
                    callback(
                        new Deno.UnsafePointerView(responseId).getCString(),
                    );
                },
            ),
        );
